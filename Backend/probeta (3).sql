...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-04-2025 a las 13:39:25
...
--
ALTER TABLE `artistas`
  MODIFY `idArtista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT de la tabla `disenyos`
--
ALTER TABLE `disenyos`
  MODIFY `idDisenyo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
